...
public  class NumberToLetters {
    ...
    private static final String[] DECENAS = {"VENTI", "TREINTA ", "CUARENTA ", "CINCUENTA ",
    ...
    public static String convertNumberToLetter(double doubleNumber) throws NumberFormatException {
        ...
        if (doubleNumber > 999999999) {
            throw new NumberFormatException("El numero es mayor a 999'999.999, "
        ...
        String splitNumber[] = numberFormat.format(doubleNumber).replace('.', '#').split("#");
