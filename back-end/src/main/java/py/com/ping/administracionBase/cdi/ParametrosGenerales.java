...
import py.com.ping.administracionBase.ejb.BswFormasEJB;
import py.com.ping.administracionBase.ejb.BswParametrosGeneralesEJB;
...
public class ParametrosGenerales implements Serializable {
    private static final Logger log =
            LoggerFactory.getLogger(ParametrosGenerales.class);
    @PersistenceContext
